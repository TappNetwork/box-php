...
class Client
{
    ...
    /**
     * Copy a file or folder to a different location in the user's Box.
     *
    ...
    /**
     * Download a file from a user's Box.
     *
     * @param string $path
     *
     * @return resource
    ...
    /**
     * Move a file or folder to a different location in the user's Box.
     *
     ...
     * Box API v2 limits the content size to 150MB.
     *
     ...
     * @param int $chunkSize
     * @param \TappNetwork\Box\UploadSessionCursor|null $cursor
     * @return \TappNetwork\Box\UploadSessionCursor
     * @throws Exception
     */
    ...
    {
        $headers = ['Box-API-Arg' => json_encode($arguments)];
