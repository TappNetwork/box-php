...
namespace TappNetwork\Box\Test;
...
use TappNetwork\Box\UploadSessionCursor;
...
class ClientTest extends TestCase
{
    ...
    public function it_can_get_a_temporary_link()
    {
        ...
        $this->assertEquals(
            'https://dl.boxusercontent.com/apitl/1/YXNkZmFzZGcyMzQyMzI0NjU2NDU2NDU2',
    ...
    public function it_can_get_account_info()
    {
        $expectedResponse = [
            ...
            'profile_photo_url' => 'https://dl-web.box.com/account_photo/get/dbid%3AAAH4f99T0taONIb-OurWxbNQ6ywGRopQngc?vers=1453416673259&size=128x128',
            'country' => 'US',
        ];
    ...
    public function it_can_list_shared_links()
    {
        ...
        $this->assertEquals(
            ['url' => 'https://dl.boxusercontent.com/apitl/1/YXNkZmFzZGcyMzQyMzI0NjU2NDU2NDU2'],
    ...
    {
        $class = new \ReflectionClass('TappNetwork\Box\Client');
